	...
	implements 	PEPeerTransport
{
  ...
  public void setOptimisticUnchoke( boolean is_optimistic ) {
	...
	public int compareTo(PEPeerTransport other) {
		...
		//if it's a read-only peer, we don't need to do anything to get recip
		return new Double(0).compareTo(other.getTyrantScore());
	}
	...
	public double getTyrantScore() {
		//this is a free source of pieces, no data payload upload required
		return 0;
	}


	public boolean isSelfishTyrantPeer() {
		// doesn't matter, we can't upload to seeds
		return false;
	}	
}
