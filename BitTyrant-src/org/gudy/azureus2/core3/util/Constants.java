...
Constants 
{
  ...
  public static final String AZUREUS_NAME	  = "Azureus"+TyrantStats.TYRANT_GUI_TEXT_STRING;
  public static final String AZUREUS_VERSION  = "2.5.0.0"+TyrantStats.TYRANT_GUI_TEXT_STRING;  //2.5.0.1_CVS
  public static final byte[] VERSION_ID       = ("AZ" + "2500" + "BT").getBytes();  //MUST be 8 chars long!
