 ...
 * @author Jarret
 * 			2006/Oct/11: Add items to view reciprication estimates for UL,DL, and DL/UL
 */
       ...
       implements DownloadManagerPeerListener
{
  private static final TableColumnCore[] basicItems = {
	  //new EstimateULForRecipItem(), //show how much UL is needed
	  //new EstimateDLFromRecipItem(), //show how much DL is needed
	  new BitsAllocatedForUploadItem(), //and what the upload capacity allocation is
	  new IsTyrantPeerItem(), //and if they're selfish
	  new RecentUpDownRatioItem(), // recent ratio
	  new LastTyrantActionItem(),
	  new IpItem(),
    new ClientItem(),
    new TypeItem(),
    new MessagingItem(),
