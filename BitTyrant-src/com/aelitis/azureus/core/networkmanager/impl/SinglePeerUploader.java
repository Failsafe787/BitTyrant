...
////////////////RateControlledWriteEntity implementation ////////////////////
  ...
  public boolean doProcessing(EventWaiter waiter) {
    ...
    int connection_limit = connection.getBandwidthLimit();
    /*
    if(connection_limit < 1){
    	//this connection will have to wait for someone else to give it some bandwidth.
    	return false;
    }
    */
    ...
    /*
    if(num_bytes_to_write > connection_limit)
    	num_bytes_to_write = connection_limit;
    */
    ...
    try {
      ...
      connection.setBandwidth(connection_limit-written);
      //System.out.println("single peer uploader: "+connection+" wrote " + written + ", future limited to " + connection.getBandwidthLimit());
    }
    catch( Throwable e ) {
