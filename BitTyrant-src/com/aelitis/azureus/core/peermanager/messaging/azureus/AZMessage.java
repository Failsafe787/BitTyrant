...
public interface AZMessage extends Message {
  ...
  //a message to tell peers we're selfish
  //these are unused, for now
  public static final String ID_AZ_BTYRANT_SELFISH		= "BTYRANT";
  public static final byte[] ID_AZ_BTYRANT_SELFISH_BYTES = ID_AZ_BTYRANT_SELFISH.getBytes();
  public static final int SUBID_AZ_BTYRANT_SELFISH		= 3;
